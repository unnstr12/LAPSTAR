CREATE DATABASE  IF NOT EXISTS `lapvn` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `lapvn`;
...
--
-- Table structure for table `laptopModels`
--

DROP TABLE IF EXISTS `laptopModels`;
...
--
-- Dumping data for table `laptopModels`
--

LOCK TABLES `laptopModels` WRITE;
/*!40000 ALTER TABLE `laptopModels` DISABLE KEYS */;
INSERT INTO `laptopModels`
